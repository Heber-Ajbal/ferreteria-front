        ...
        <template #default="{ isShowMenu }">
          ...
          <div class="hidden lg:flex items-center gap-3">
            ...
            <button v-else @click="auth.logout"
              class="flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold bg-red-300 hover:bg-red-400 hover:!text-white transition-all duration-300">
              🚪 <span>Logout</span>
            </button>
          ...
          <!-- Mobile -->
          <FwbNavbarCollapse :is-show-menu="open || isShowMenu" class="lg:hidden mt-4 flex flex-col gap-2">
            <RouterLink to="/"
